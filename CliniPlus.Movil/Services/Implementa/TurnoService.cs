...
namespace CliniPlus.Movil.Services.Implementa
{
    public class TurnoService : ITurnoService
    {
        ...
        public async Task<List<HistoriaClinicaListadoDTO>?> ObtenerHistoriaClinicaAsync(int pacienteId, DateTime? desde, DateTime? hasta)
        {
            var cli = CreateClient();
        ...
        public async Task<List<HistoriaClinicaListadoDTO>?> ObtenerMiHistoriaClinicaAsync(DateTime? desde, DateTime? hasta)
        {
            var cli = CreateClient();
        ...
        public async Task<List<HistoriaClinicaListadoDTO>?> ObtenerHistoriaSecretariaAsync(int pacienteId, DateTime? desde, DateTime? hasta)
        {
            var cli = CreateClient();
